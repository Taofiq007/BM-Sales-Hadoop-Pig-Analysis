...
grp = GROUP clean BY store_id;
agg = FOREACH grp GENERATE group AS store_id,
    SUM(clean.total_value) AS total_revenue;
sorted = ORDER agg BY total_revenue DESC;
top10 = LIMIT sorted 10;
STORE top10 INTO 'hdfs:///user/HP/BM_Sales_Hadoop_Pig_Project/output/pig/pig3_top10_stores' USING PigStorage(',');
